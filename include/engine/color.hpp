...
union Color {
  ...
  constexpr Color(unsigned char a, unsigned char r, unsigned char g,
                  unsigned char b)
      : channels({.b = b, .g = g, .r = r, .a = a}) {};

  constexpr Color(float a, float r, float g, float b)
      : channels({.b = static_cast<unsigned char>(b * 255),
                  .g = static_cast<unsigned char>(g * 255),
                  .r = static_cast<unsigned char>(r * 255),
                  .a = static_cast<unsigned char>(a * 255)}) {}

  constexpr Color(unsigned int color)
      : channels(
